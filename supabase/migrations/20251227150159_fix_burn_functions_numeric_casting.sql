/*
  # Fix Burn Aggregation Functions Numeric Casting
  
  1. Changes
    - Cast calculation results to numeric to match function return type
  
  2. Purpose
    - Resolve type mismatch errors between double precision and numeric
*/
