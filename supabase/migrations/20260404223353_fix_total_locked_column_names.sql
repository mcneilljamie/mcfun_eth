/*
  # Fix Total Locked Calculation Column Names

  1. Changes
    - Fix column names in update_platform_stats function to match token_locks table
    - Use `amount_locked` instead of `amount`
    - Use `is_withdrawn` instead of `withdrawn`
    - Use `unlock_timestamp` instead of `unlock_time`
*/
