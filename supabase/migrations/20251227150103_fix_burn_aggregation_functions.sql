/*
  # Fix Burn Aggregation Functions
  
  1. Changes
    - Fix column reference from `t.address` to `t.token_address`
    - Fix table reference from `amm_pairs` to use `tokens` table reserves
    - Update joins and column references to match actual schema
  
  2. Tables Used
    - `token_burns` - burn records
    - `tokens` - token metadata and reserves
*/
