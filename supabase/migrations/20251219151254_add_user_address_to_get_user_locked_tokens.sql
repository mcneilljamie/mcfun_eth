/*
  # Add user_address to get_user_locked_tokens Return Type

  1. Changes
    - Drop and recreate `get_user_locked_tokens` function with `user_address` field
    - This field is needed by the MyLocks page component

  2. Security
    - No security changes, maintains existing SECURITY DEFINER policy
*/
