/*
  # Revert Platform Stats to Use Snapshot ETH Prices
  
  1. Changes
    - Revert platform stats calculation to use eth_price_usd from price_snapshots
    - Historical snapshots contain the ETH price at the time of the snapshot
    - This is the correct approach for historical price data
  
  2. Purpose
    - Snapshots are meant to preserve historical ETH prices
    - Reverts incorrect change that used eth_price_history
*/
