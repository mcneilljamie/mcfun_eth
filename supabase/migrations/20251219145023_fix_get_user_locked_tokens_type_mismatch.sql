/*
  # Fix Type Mismatch in get_user_locked_tokens Function

  1. Changes
    - Fix type mismatch error where `amount_locked_formatted` was returning `double precision` instead of `numeric`
    - Explicitly cast the division result to `numeric` type
    - This fixes the portfolio locked value calculation

  2. Security
    - No security changes, just a type casting fix
*/
