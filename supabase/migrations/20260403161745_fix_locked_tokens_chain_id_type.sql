/*
  # Fix Locked Tokens Function - Chain ID Type Mismatch

  1. Changes
    - Change chain_id return type from integer to bigint to match table column
    - Fixes type mismatch error preventing function from executing

  2. Purpose
    - Allow function to execute and return locked token data with chain_id
    - Fix "$0.00" value display issue for locked tokens
