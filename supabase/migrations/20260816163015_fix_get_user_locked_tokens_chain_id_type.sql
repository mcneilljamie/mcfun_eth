/*
# Fix chain_id type in get_user_locked_tokens

1. Problem
   - token_locks.chain_id is bigint, but get_user_locked_tokens declared chain_id as integer.
   - Same type mismatch as the other lock functions.

2. Changes
   - Change return type of chain_id from integer to bigint
*/
