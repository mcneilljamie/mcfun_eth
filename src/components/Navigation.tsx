          ...
          <div className="flex items-center gap-3">
            ...
            {account ? (
              ...
              <button
                ...
                className="group relative bg-gradient-to-r from-gray-900 to-gray-800 text-white px-4 sm:px-6 py-2.5 rounded-xl text-sm sm:text-base font-semibold hover:from-gray-800 hover:to-gray-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl hover:scale-105 border border-gray-700 overflow-hidden"
              >
                {isConnecting && (
