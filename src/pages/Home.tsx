      ...
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
          <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2">Lightning Fast</h3>
          ...
          <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2">Unruggable</h3>
            <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2">No Token Creation Fees</h3>
            <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2">Fair Launch</h3>
            <p className="text-sm sm:text-base text-gray-600">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 mb-12 sm:mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Add Liquidity</h3>
              <p className="text-sm sm:text-base text-gray-600">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl shadow-lg p-6 sm:p-8 text-white text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Why Choose McFun?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <div className="bg-white/10 backdrop-blur-sm px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg">
              ...
              <div className="text-xs sm:text-sm text-gray-300">Fixed Supply</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg">
              <div className="text-xl sm:text-2xl font-bold">0.1 ETH</div>
              <div className="text-xs sm:text-sm text-gray-300">Min Liquidity</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg">
              <div className="text-xl sm:text-2xl font-bold">0.4%</div>
              <div className="text-xs sm:text-sm text-gray-300">Trading Fee</div>
            </div>
          </div>
        </div>
      </div>
