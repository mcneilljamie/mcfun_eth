                ...
                <div className="flex flex-wrap items-center gap-2 mt-3">
                  {token.telegram_url && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-3 py-1.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium transition-colors flex items-center space-x-1.5"
                      title="Join Telegram"
                    >
